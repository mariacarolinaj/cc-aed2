...
public class TP02Q07PesquisaSequencial {
    ...
    public static void main(String args[]) throws Exception {
        ...
        String[] chavesPesquisa = new String[1000];
        ...
        posicaoUltimoDadoLido = 0;

        // lê o nome dos times a serem pesquisados
        do {
            chavesPesquisa[posicaoUltimoDadoLido] = MyIO.readLine();
        } while (!isFim(chavesPesquisa[posicaoUltimoDadoLido++]));

        // Desconsidera a ultima linha em que foi inserido a palavra FIM
        posicaoUltimoDadoLido--;

        for (int indice = 0; indice < posicaoUltimoDadoLido; indice++) {
            boolean timeExiste = times.pesquisar(chavesPesquisa[indice]);
            if (timeExiste) {
                MyIO.println("SIM");
            } else {
                MyIO.println("NÃO");

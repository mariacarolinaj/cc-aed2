...
class Lista {
   ...
   public void inserir(int posicao, Time time) throws Exception {
      ...
      if (posicao == 0) {
         ...
         posicaoAInserir.Proximo = novaCelula;
      }
   }
   ...
   public Time removerNoFim() throws Exception {
      ...
      Celula ultimaCelula;
      // caminha até a última celula anterior ao valor armazenado no ponteiro "Ultimo"
      for (ultimaCelula = Primeiro; ultimaCelula != Ultimo; ultimaCelula = ultimaCelula.Proximo)
         ;
   ...
   public Time remover(int posicao) throws Exception {
      ...
      if (posicao == 0) {
         ...
         Celula celulaRemovida = posicaoARemover.Proximo;
         posicaoARemover.Proximo = celulaRemovida.Proximo;

...
public class TP01Q03Palindromo {
    ...
    public static boolean isPalindromo(String palavra) {
        ...
        for (int posicaoInicial = 0; posicaoInicial < palavra.length() / 2; posicaoInicial++) {
            if (isEquals(palavra.charAt(posicaoInicial), palavra.charAt(posicaoFinal))) {
                posicaoFinal--;
            } else {
                palindromo = false;
                posicaoInicial = palavra.length() / 2;
            }
        }

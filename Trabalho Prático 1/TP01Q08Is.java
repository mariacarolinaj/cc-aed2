...
public class TP01Q08Is {
    ...
    public static boolean verificarSePossuiApenasVogais(String palavra) {
    ...
    public static boolean verificarSePossuiApenasConsoantes(String palavra) {
    ...
    public static boolean verificarSeEhNumeroInteiro(String palavra) {
    ...
    public static boolean verificarSeEhNumeroReal(String palavra) {
        boolean ehReal = true;
    ...
    public static String avaliarString(String palavra) {
        ...
        if (verificarSePossuiApenasVogais(palavra)) {
            resultado += "SIM";
        } else {
            resultado += "NAO";
        }

        if (verificarSePossuiApenasConsoantes(palavra)) {
            resultado += " SIM";
        } else {
            resultado += " NAO";
        }

        if (verificarSeEhNumeroInteiro(palavra)) {
            resultado += " SIM";
        } else {
            resultado += " NAO";
        }

        if (verificarSeEhNumeroReal(palavra)) {
            resultado += " SIM";
        } else {
            resultado += " NAO";
        }
